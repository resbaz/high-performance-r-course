...
**What does the lapply2 function do? Check compute time difference between `lapply` and `lappy2`.**

- To do this you could appley the function `mean` to `x=list(1:200,1:10,100:340,10:90)`
